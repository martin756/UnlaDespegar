  ...
  <div>
    <div v-if="localShowList">
      ...
      <div class="d-flex justify-content-center">
        <b-card v-for="reserva in localReservasActivas" :key="reserva.id" img-alt="Image" img-top
          class="mb-2 flight">
    ...
    <div v-if="localShowDetalle">
      ...
      <main role="main" class="container">
        ...
        <div v-if="localReservaSeleccionada.vuelo != null">
          <div class="d-flex align-items-start flex-column my-3 p-3 bg-white rounded box-shadow">
            <h2>Vuelo</h2>
            <button v-if="!localReservaSeleccionada.reservaFinalizada" @click="eliminarVuelo()" class="btn">
      ...
      <div class="row">
        <div class="options text-center">
          ...
          <button v-if="!localReservaSeleccionada.reservaFinalizada" @click="confirmarReserva" type="button"
  ...
  methods: {
    ...
    modificarPasajero() {
      if (confirm("Desea Guardar Cambios?"))
        this.$axios
          .put(
            "https://localhost:57935/api/pasajero/" + this.localPasajeroToEdit.id,
            {
